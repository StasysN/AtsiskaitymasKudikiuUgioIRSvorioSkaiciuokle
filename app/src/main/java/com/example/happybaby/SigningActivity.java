...
public class SigningActivity extends AppCompatActivity {
    ...
    EditText username, password, repassword, userID;
               ...
               // String userId = userID.getText().toString();
                ...
                if (user.equals("") || pass.equals("") || repass.equals(""))
                    ...
                    if (pass.equals(repass)) {
                        ...
                        if (checkuser == false) {
                            Boolean insert = DB.insertData(/*userId,*/ user, pass);
                            if (insert == true) {
                                ...
                                Toast.makeText(SigningActivity.this, "Registered failed", Toast.LENGTH_LONG).show();
                            }
                        } else {
                            Toast.makeText(SigningActivity.this, "User already exist! Please sign in", Toast.LENGTH_LONG).show();
                        }
                    } else {
                        Toast.makeText(SigningActivity.this, "Password not matching!", Toast.LENGTH_LONG).show();
                    }
                }
